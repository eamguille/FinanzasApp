            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('entradas.update', $entrada->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tipo" id="tipo" value="{{ old('tipo', $entrada->tipo) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="monto" id="monto" value="{{ old('monto', $entrada->monto) }}" step="0.01" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>

                    <div class="mb-4">
                        <label for="fecha" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Fecha</label>
                        <input type="date" name="fecha" id="fecha" value="{{ old('fecha', $entrada->fecha) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img src="{{ asset('storage/' . $entrada->factura) }}" alt="Factura actual"
                            class="w-40 h-auto rounded border dark:border-gray-500">
                    </div>
                    @endif
